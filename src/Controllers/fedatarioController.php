...
class fedatarioController extends Controller
{
    ...
    public function listar_plantilla_fedatario(){
            ...
            function ($id_asociado, $usuario_creador, $count, $request) {
                ...
                if ($count > 0) {
                    ...
                    $log->create_log_ez(
                        ...
                        'FED-NOR-FIN',//$log_proceso  ,
                        'Finalizar Registro de Fedatario Revisar Normal - Reproceso',//$log_descripcion  ,
                        '',//$log_comentario  ,
                        null//$log_archivo_id
                    );
                    ...
                    $log->create_log_ez(
                        ...
                        'fedatario',//$log_tabla_asociada  ,
                        'FED-NOR-FIN',//$log_proceso  ,
                        'Finalizar Registro de Fedatario Revisar Normal - Revisión Documento',//$log_descripcion  ,
                        '',//$log_comentario  ,
                        null//$log_archivo_id
                    );
                    ...
                    if( count($resultado_update_grupo)>0 ){
                        ...
                        //solo si el guardar grupo retorna varios registros, creamos el fedatario firmar para todo el grupo
                        //y tambien actualizamos el estado glb del grupo
                        //$this->estado_captura_glb($captura_id, $cap_est_glb_1);
                    }
                    //(new App\fedatario_firmar())->crear_fedatario_firmar_from_fedatario($captura_id,$usuario_creador,$recepcion_id,$fedatario_id,$cc_id,$proyecto_id,$indizacion_id,$cliente_id);
    ...
    function retorna_autoasignacion_nueva_captura($proyecto_id,$recepcion_id,$captura_id,$usuario_id){
        $data = (array)DB::select(
            ...
            where (b.usuario_asignado_fed_revisar_nor is null or b.usuario_asignado_fed_revisar_nor=:user)
            and a.fedatario_estado=0
            and a.fedatario_tipo='NORMAL'
